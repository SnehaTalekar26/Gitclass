...
public class MainRunner {
    public static void main(String[] args){
        ...
        Festival festival2=new Christmas();
        festival2.Banner();
        festival2.Celebrate();
        festival2.eatSweets();
        festival2.Name();
        ...
        Animals animals1=new Elephant();
        animals1.eat();
        animals1.sleep();
        animals1.vet();
        animals1.growth();
        animals1.livingBeings();
        ...
        IceCream iceCream2=new DairyDay();
        iceCream2.scoop();
        iceCream2.flavor();
        iceCream2.eatScoop();
        iceCream2.select();
        ...
        DairyDay dairyDay=new DairyDay();
        dairyDay.scoop();
        dairyDay.flavor();
        dairyDay.eatScoop();
        dairyDay.select();
        ...
        IceCream iceCream4=new Nandini();
        iceCream4.scoop();
        iceCream4.flavor();
        iceCream4.eatScoop();
        iceCream4.select();
